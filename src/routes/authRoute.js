...
const {loginValidation,registerValidation,loginNicknameValidation} = require("../validations/AuthValidation")
const validation = require("../middleware/validate")
const router = express.Router();

router.post("/login",validation(loginValidation),AuthService.loginUser)
router.post("/login/nickname",validation(loginNicknameValidation),AuthService.loginNicknameUser)
